...
{
    public class MainArchivePanel : BaseUGUIPanel
    {
        ...
        [SerializeField] private ArchiveSceneGotoSO sceneGotoScene;
        [SerializeField] private RecyclerViewSelectable recyclerViewSelectable;
        [SerializeField] private MainArchiveListAdapter adapter;
        ...
        private MainArchiveModel _archiveModel;
        ...
        protected override void OnShow(object payload)
        {
            ...
            _archiveModel = new MainArchiveModel(GameApplication.Instance.ArchiveManager,
                GameApplication.Instance.ExcelBinaryManager.GetContainer<MapInfoContainer>());
            ...
            else
            {
                ...
                if (_eventSystem.currentSelectedGameObject)
                {
                    var archiveItemViewHolder =
                        _eventSystem.currentSelectedGameObject.GetComponent<MainArchiveItemViewHolder>();
        ...
        {
            _panelManager.Hide<MainArchivePanel>();
        }

        private void HandleDeleteConfirmed(InputAction.CallbackContext obj)
        {
            if (!Focus || !_eventSystem.currentSelectedGameObject) return;
            var itemViewHolder = _eventSystem.currentSelectedGameObject.GetComponent<MainArchiveItemViewHolder>();
        ...
        private void HandleArchiveItemClicked(MainArchiveItemUIData data)
        {
            sceneGotoScene?.Goto(new ArchiveSceneGotoParameters()
            {
                Id = data.Id,
            });
        }

        private void HandleArchiveItemDeleted(MainArchiveItemUIData data)
        {
