...
{
    [Category("Quest")]
    public class DialogueCheckQuestIsComplete: ConditionTask
    {
        ...
        protected override string info => $"Check quest(id={id}) is complete";
        ...
        protected override bool OnCheck()
        {
            ...
            {
                return quest.state.IsQuestCompleted();
            }
