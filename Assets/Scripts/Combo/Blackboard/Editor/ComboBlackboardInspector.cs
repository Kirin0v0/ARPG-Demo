...
{
    [CustomEditor(typeof(ComboBlackboard))]
    public class ComboBlackboardInspector : UnityEditor.Editor
    {
        private ComboBlackboard _blackboard;
        ...
        {
            _blackboard = serializedObject.targetObject as ComboBlackboard;

            var root = new VisualElement();
            // 引用UXML
            var visualTree =
                AssetDatabase.LoadAssetAtPath<VisualTreeAsset>(
                    "Assets/Scripts/Combo/Blackboard/Editor/ComboBlackboardInspector.uxml");
            ...
            objectField.objectType = typeof(ComboBlackboard);
        ...
        private void InitOthersUI()
        {
            ...
            {
                var tipsProperty = serializedObject.FindProperty("tips");
                var globalSharedColliderGroupSettingsProperty =
                    serializedObject.FindProperty("globalSharedColliderGroupSettings");
                serializedObject.Update();
                EditorGUILayout.PropertyField(tipsProperty);
                EditorGUILayout.PropertyField(globalSharedColliderGroupSettingsProperty);
                serializedObject.ApplyModifiedProperties();
            };
        }
    }
