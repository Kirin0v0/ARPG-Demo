...
{
    [NodeMenuItem("Action/Character/Target/Warning and Battle/Farthest Character")]
    public class CharacterFarthestEnemyTargetNode : BaseCharacterTargetNode
    {
        ...
        protected override NodeState OnTick(float deltaTime, object payload)
        {
            ...
            {
                if ((enemy.Visual.Center.position - parameters.Character.Visual.Center.position).sqrMagnitude >
                    (farthest.Visual.Center.position - parameters.Character.Visual.Center.position).sqrMagnitude)
                {
                    farthest = enemy;
                }
            });
            
            ShareTarget(parameters, farthest);
