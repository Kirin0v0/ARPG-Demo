...
{
    public class CharacterBatBrain : CharacterBehaviourTreeBrain
    {
        private float _attackCooldown = 0f;
        private float _biteCooldown = 0f;
        ...
        protected override void OnLogicThoughtsUpdated(float fixedDeltaTime)
        {
            ...
            {
                 Owner.GravityAbility.SetGravityEnable(true);
            }
            UpdateBatState();
        }
        ...
        protected override void SetBlackboardBeforeExecuteTick(Blackboard blackboard, float deltaTime)
        {
            ...
            _biteCooldown = Mathf.Clamp(_biteCooldown - deltaTime, 0f, _biteCooldown);
            ...
            blackboard.SetFloatParameter("biteCooldown", _biteCooldown);
        ...
        protected override void GetBlackboardAfterExecuteTick(Blackboard blackboard)
        {
            ...
            _biteCooldown = blackboard.GetFloatParameter("biteCooldown");
